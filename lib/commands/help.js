    ...
    return {
        ...
        execute(message, args) {
            ...
            if (args.length == 1){
                ...
                data.push(`\nAfin de lancer la validation, utilisez la commande link comme suit: \`!UB  link numeroDuProfil\`. Le numéro de profil ??? est récupérable dans l'url  http://forum.com/u???.`);
            }
            else{
